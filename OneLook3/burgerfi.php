...
//current URL of the Page. burgerfi_update.php redirects back to this URL
...
if(isset($_SESSION["burgerfi_items"]) && count($_SESSION["burgerfi_items"])>0)
{
	...
	echo '<td colspan="4">';
	echo '<button type="submit">Update</button><a href="burgerfi_cart.php" class="button">Checkout</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
