...
//current URL of the Page. tamarind_update.php redirects back to this URL
...
if(isset($_SESSION["tamarind_items"]) && count($_SESSION["tamarind_items"])>0)
{
	...
	echo '<td colspan="4">';
	echo '<button type="submit">Update</button><a href="tamarind_cart.php" class="button">Checkout</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
