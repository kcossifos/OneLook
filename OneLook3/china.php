...
<!-- View Cart Box Start -->
<?php
if(isset($_SESSION["china_items"]) && count($_SESSION["china_items"])>0)
{
	echo '<div class="shoppingcart" id="view-cart">';
	echo '<h3>Your Menu Items</h3>';
	echo '<form method="post" action="china_update.php">';
	...
	echo '<td colspan="4">';
	echo '<button class="button" type="submit">Update</button><a href="china_cart.php" class="button">Checkout</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
