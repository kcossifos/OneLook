...
<table width="100%"  cellpadding="6" cellspacing="0"><thead><tr><th>Quantity</th><th>Name</th><th>Price</th><th>Total</th><th>Remove</th></tr></thead>
  <tbody>
 	...
 	<?php
	if(isset($_SESSION["armandos_items"])) //check session var
    {
    ...
    <tr><td colspan="5"><span style="float:right;text-align: right;"><?php echo $tax; ?></span></td></tr>
		...
		<tr><td></td></tr>
		<tr><td></td></tr>
		<tr><td colspan="5"><a href="armandos.php" class="button">Add More Items</a><button type="submit">Update</button></td></tr>
  </tbody>
</table>
